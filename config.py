...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/venompower/rahulmusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/biorahul")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/biorahulop")
